...
class api:
    ...
    def __init__(self, name=None, ownerid=None, version=None, hash_to_check=None, owner_id=None, secret=None, **kwargs):
        if owner_id is not None:
            ownerid = owner_id
        
        if ownerid and len(ownerid) != 10:
    ...
    def init(self):
        ...
        self.sessionid = "AZDQZDQZDQZ3333"
